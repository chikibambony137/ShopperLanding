<template>
  <section class="grid justify-center items-center px-30">
    ...
    <div class="flex justify-center items-center mb-10 gap-8">
      <RadioButton value="toppicks" group="type" v-model="selectedValue">
        Top Picks
      </RadioButton>
      <RadioButton value="watches" group="type" v-model="selectedValue">
        Watches
      </RadioButton>
    </div>
    <div class="flex">
...
const selectedValue = ref("toppicks"); // Значение по умолчанию
</script>
